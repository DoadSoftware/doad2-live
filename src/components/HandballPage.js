  ...
  return (
    <div style={{ backgroundColor: 'black', color: 'white', minHeight: '100vh', padding: '20px', display: 'flex', flexDirection: 'column' }}>
      <div style={{ width: '100%', boxSizing: 'border-box', padding: '20px', marginBottom: '20px' }}>
             <h1 style={{ fontSize: '2.5rem', fontWeight: 'bold', color: '#ff6600', textShadow: '-0px -0px 0 #00ccff, 0px -0px 0 #00ccff, -0px 0px 0 #00ccff, 0px 0px 0 #00ccff, 0px 0px 1px #000000', letterSpacing: '2px', background: 'linear-gradient(45deg, #ffcc00, #ff3300)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Handball<br /></h1>
